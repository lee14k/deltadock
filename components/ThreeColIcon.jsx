...
export default function ThreeColIcon() {
  ...
  return (
    <div className="three-icon-home text-white flex flex-col justify-center items-center gap-12">
      ...
      <p className={` lg:mx-48 text-center text-2xl`}>We service, install, and repair overhead garage doors, openers, and loading docks for the residential and commercial customers within a 2-hour radius of Escanaba, MI</p>
