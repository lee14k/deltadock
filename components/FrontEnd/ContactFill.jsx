...
export default function ContactFill() {
  ...
  return (
    <div className="isolate px-6 py-24 sm:py-32 lg:px-8 grid lg:grid-cols-2 customcontact">
      <div className="mx-auto  grid bg-white px-48 py-12 lg:px-12 text-left">
        ...
        <h4 className="text-lg font-semibold text-gray-900 mt-4">Find us on Facebook!</h4>
        <p className="text-lg text-gray-900">Questions? Call (906)-221-5371</p>
